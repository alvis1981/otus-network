...
class Auth extends CI_Controller {
    ...
    public function registration() {        
        $data = array();
        $data['metaDescription'] = 'Регистрация';
        $data['metaKeywords'] = 'Регистрация';
        $data['title'] = "Регистрация - Otus";
    ...
    public function login() {        
        $data = array();
        $data['metaDescription'] = 'Авторизация';
        $data['metaKeywords'] = 'Авторизация';
        $data['title'] = "Авторизация - Otus";
        $data['breadcrumbs'] = array('Авторизация' => '#');
    ...
    public function profile() {  
        if ($this->session->userdata('ci_seesion_key')['is_authenticate_user'] == FALSE) {
            ...
            $data['title'] = "Профиль - Otus";
            $data['breadcrumbs'] = array('прифиль' => '#');
