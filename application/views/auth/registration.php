                ...
                <div class="card-body p-3">                
                    ...
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="first-name" name="first_name" placeholder="Имя">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-2">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="contact-no" name="contact_no" placeholder="Номер телефона без 8">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="address" name="address" placeholder="Город">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="dob" name="dob" placeholder="Дата рождения">
                        </div>
                    </div>
                                                       
                    <div class="text-center">
                        <button type="submit" id="contact-send-a" class="btn btn-info btn-block rounded-0 py-2">Регистрация</button>
                    </div>
