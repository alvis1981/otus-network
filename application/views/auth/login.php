            ...
            <div class="card border-info rounded-0">
                ...
                <div class="card-body p-3">                
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="remember" <?php if(isset($_COOKIE["loginId"])) { ?> checked="checked" <?php } ?>> Запомнить меня
                            </label>                                    
                        </div>
                    </div>
                    
                    <div class="text-center">
                        <button type="submit" id="contact-send-a" class="btn btn-info btn-block rounded-0 py-2">Вход</button>
                    </div>
                    <br>
                    <span>Вы пользователь? <a href="<?php print site_url()?>auth/registration">Регистрация</a></span>
                </div>
            </div> 
          </div>
        </div>
